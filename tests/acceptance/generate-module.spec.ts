...
describe("Acceptance: ng generate module", () => {
    ...
    it("will fail if no name is specified", done => {
        return ng(["generate", "module"])
            .catch((error: string) => {
                expect(error).toBe(
                    "The `ng generate module` command requires a name to be specified."
                );
            })
            .then(done, done.fail);
    });
    ...
    it("ng generate module my-module", done => {
        return ng(["generate", "module", "my-module"])
            .then(() => {
                expect(
                    fs.pathExistsSync(
                        path.join(testPath, "my-module", "my-module.module.ts")
                    )
                ).toBe(true);
                expect(
                    fs.pathExistsSync(
    ...
    it("ng generate module  generate routing file when passed flag --routing", done => {
        return ng(["generate", "module", "my-module", "--routing"])
            .then(() => {
                expect(
                    fs.pathExistsSync(
                        path.join(testPath, "my-module", "my-module.module.ts")
    ...
    it("ng generate module my-module --spec", done => {
        return ng(["generate", "module", "my-module", "--spec"])
            .then(() => {
                expect(
                    fs.pathExistsSync(
                        path.join(testPath, "my-module", "my-module.module.ts")
    ...
    it("ng generate module TwoWord", done => {
        return ng(["generate", "module", "TwoWord"])
            .then(() => {
                expect(
                    fs.pathExistsSync(
                        path.join(testPath, "two-word", "two-word.module.ts")
                    )
                ).toBe(true);
                expect(
                    fs.pathExistsSync(
    ...
    it("ng generate module parent/child", done => {
        return ng(["generate", "module", "parent"])
            ...
            .then(() => {
                expect(
                    fs.pathExistsSync(
                        path.join(testPath, "parent/child", "child.module.ts")
                    )
                ).toBe(true);
                expect(
                    fs.pathExistsSync(
    ...
    it("ng generate module child should work in sub-dir", done => {
        ...
        return new Promise(resolve => {
            ...
            .then(() => {
                expect(
                    fs.pathExistsSync(
                        path.join(testPath, "sub-dir/child", "child.module.ts")
                    )
                ).toBe(true);
                expect(
                    fs.pathExistsSync(
    ...
    it(
        "ng generate module child should work in sub-dir with routing file when passed " +
            "--routing flag",
        done => {
            fs.mkdirSync(path.join(testPath, "./sub-dir"));
            return new Promise(resolve => {
    ...
    // tslint:disable-next-line:max-line-length
    it(
        "ng generate module should generate parent/child module with routing file when " +
            "passed --routing flag",
        done => {
            return ng(["generate", "module", "parent"])
                .then(() =>
                    ng(["generate", "module", "parent/child", "--routing"])
                )
                .then(() => {
                    expect(
                        fs.pathExistsSync(
