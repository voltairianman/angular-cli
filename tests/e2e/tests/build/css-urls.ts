    ...
    return (
      ...
      `,
            ...
            .then(() =>
                copyProjectAsset(
                    "images/spectrum.png",
                    "./assets/global-img-relative.png"
                )
            )
            .then(() =>
                copyProjectAsset(
                    "images/spectrum.png",
                    "./assets/component-img-relative.png"
                )
            )
            ...
            .then(() =>
                expectToFail(() =>
                    expectFileToExist("dist/global-img-absolute.svg")
                )
            )
            .then(() =>
                expectToFail(() =>
                    expectFileToExist("dist/component-img-absolute.svg")
                )
            )
            .then(() =>
                expectFileMatchToExist(
            ...
            .then(() =>
                ng("build", "--base-href=/base/", "--extract-css", "--aot")
            )
            .then(() =>
                expectFileToMatch(
                    "dist/styles.bundle.css",
