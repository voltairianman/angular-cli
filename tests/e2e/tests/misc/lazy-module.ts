...
export default function() {
    ...
    `
            ...
            .then(distFiles => {
                ...
                if (oldNumberOfFiles >= currentNumberOfDistFiles) {
                    throw new Error(
                        "A bundle for the lazy module was not created."
                    );
                }
                ...
                if (!distFiles.includes("lazy.module.chunk.js")) {
                    throw new Error(
                        "The lazy module chunk did not have a name."
                    );
                }
                if (!distFiles.includes("lazy.module.0.chunk.js")) {
                    throw new Error(
                        "The lazy module chunk did not use a unique name."
                    );
                }
            })
    ...
    `
            ...
            .then(distFiles => {
                ...
                if (oldNumberOfFiles >= currentNumberOfDistFiles) {
                    throw new Error(
                        "A bundle for the lazy file was not created."
                    );
                }
    ...
    `
            ...
            .then(currentNumberOfDistFiles => {
                if (oldNumberOfFiles != currentNumberOfDistFiles) {
                    throw new Error(
                        "Bundles were not created after adding 'import *'."
                    );
                }
            })
            ...
            .then(distFiles => {
                if (
                    distFiles.includes("lazy.module.chunk.js") ||
                    distFiles.includes("lazy.module.0.chunk.js") ||
                    distFiles.includes("lazy-file.chunk.js")
                ) {
                    throw new Error(
                        "Lazy chunks shouldn't have a name but did."
                    );
                }
            })
            ...
            .then(currentNumberOfDistFiles => {
                if (oldNumberOfFiles != currentNumberOfDistFiles) {
                    throw new Error(
                        "AoT build contains a different number of files."
                    );
                }
            })
    );
