...
export function insertStarImport(
    ...
    // We don't need to verify if the symbol is already imported, star imports
    // should be unique. Create the new import node.
...
export function insertImport(
    ...
    const maybeImports = allImports
        ...
        .filter((node: ts.ImportDeclaration) => {
            // Filter out import statements that are either `import 'XYZ'` or `import * as X
            // from 'XYZ'`.
