...
export function replaceServerBootstrap(
    ...
    const standardTransform: StandardTransform = function(
        ...
        entryModuleIdentifiers.forEach(entryModuleIdentifier => {
            ...
            if (
                entryModuleIdentifier.parent.kind !==
            ...
            if (
                ...
                // Figure out if it's a `platformDynamicServer().bootstrapModule(AppModule)`
                // call.
                ...
                if (
                    ...
                    if (
                        !(
                            propAccessExpr.name.text === "bootstrapModule" &&
                            propAccessExpr.expression.kind ===
                                ts.SyntaxKind.CallExpression
                        )
                    ) {
                        return;
                    ...
                    if (
                        !(
                            innerCallExpr.expression.kind ===
                                ts.SyntaxKind.Identifier &&
                            (innerCallExpr.expression as ts.Identifier).text ===
                    ...
                    const idPlatformServer = ts.createUniqueName(
                        "__NgCli_bootstrap_"
                    );
                    const idNgFactory = ts.createUniqueName(
                        "__NgCli_bootstrap_"
                    );
                    ...
                    ops.push(
                        ...
                        new ReplaceNodeOperation(
                            sourceFile,
                            platformDynamicServerIdentifier,
                            ts.createPropertyAccess(
                                idPlatformServer,
                                "platformServer"
                            )
                ...
                // This is for things that accept a module as a property in a config object .ie
                // the express engine
