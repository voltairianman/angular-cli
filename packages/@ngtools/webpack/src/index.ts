...
// Test if typescript is available. This is a hack. We should be using
// peerDependencies instead but can't until we split global and local packages.
...
try {
    ...
    throw new Error(
        "Could not find local 'typescript' package.The '@ngtools/webpack' package requi" +
            "res a local 'typescript@^2.0.2' package to be installed." +
            e
    );
}
