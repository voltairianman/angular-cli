...
export function gatherDiagnostics(
    ...
    if (jitMode) {
        ...
        checkOtherDiagnostics =
            checkOtherDiagnostics &&
            checkDiagnostics(
                tsProgram.getSyntacticDiagnostics(undefined, cancellationToken)
            );
        timeEnd(
            `${benchmarkLabel}.gatherDiagnostics.ts.getSyntacticDiagnostics`
        );
        ...
        checkOtherDiagnostics =
            checkOtherDiagnostics &&
            checkDiagnostics(
                tsProgram.getSemanticDiagnostics(undefined, cancellationToken)
            );
        timeEnd(
            `${benchmarkLabel}.gatherDiagnostics.ts.getSemanticDiagnostics`
        );
    } else {
        ...
        time(
            `${benchmarkLabel}.gatherDiagnostics.ng.getTsSyntacticDiagnostics`
        );
        checkOtherDiagnostics =
            checkOtherDiagnostics &&
            checkDiagnostics(
        ...
        timeEnd(
            `${benchmarkLabel}.gatherDiagnostics.ng.getTsSemanticDiagnostics`
        );
        ...
        checkOtherDiagnostics =
            checkOtherDiagnostics &&
            checkDiagnostics(
                angularProgram.getNgSemanticDiagnostics(
                    undefined,
                    cancellationToken
                )
            );
        timeEnd(
            `${benchmarkLabel}.gatherDiagnostics.ng.getNgSemanticDiagnostics`
        );
    }
