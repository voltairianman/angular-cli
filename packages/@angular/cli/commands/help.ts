            ...
            if (rawArgs.length > 0) {
                ...
                if (cmd === commandInput) {
                    if (commandOptions.short) {
                        this.ui.writeLine(
                            command.printShortHelp(commandOptions)
                        );
                    } else if (
                        command.printDetailedHelp(commandOptions, rawArgs)
                    ) {
                        const result = command.printDetailedHelp(
                            commandOptions,
                            rawArgs
                        );
                        ...
                        this.ui.writeLine(
                            command.printBasicHelp(commandOptions)
                        );
                    }
                }
            } else {
