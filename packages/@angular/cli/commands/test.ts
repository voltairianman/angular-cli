...
const TestCommand = Command.extend({
    ...
    availableOptions: [
        ...
        },
        {
            ...
            default:
                typeof testConfigDefaults["progress"] !== "undefined"
    ...
    run: function(commandOptions: TestOptions) {
        const testTask = new TestTask({ ui: this.ui, project: this.project });
        ...
        // Don't force commonjs for code coverage builds, some setups need es2015 for
        // it. https://github.com/angular/angular-cli/issues/5526
