...
// Expose options unrelated to live-reload to other commands that need to run
// serve
export const baseServeCommandOptions: any = overrideOptions(
    [
        ...
        },
        {
            ...
            aliases: ["H"],
            description: `Listens only on ${
                serveConfigDefaults["host"]
            } by default.`,
        },
        {
            name: "proxy-config",
...
const ServeCommand = Command.extend({
    ...
    run: function(commandOptions: ServeTaskOptions) {
        ...
        return checkPort(
            ...
            const serve = new ServeTask({ ui: this.ui, project: this.project });
