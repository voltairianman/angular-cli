...
const NewCommand = Command.extend({
    ...
    getCollectionName(rawArgs: string[]) {
        let collectionName = CliConfig.fromGlobal().get(
    ...
    beforeRun: function(rawArgs: string[]) {
        ...
        return getOptionsTask
            ...
            .then((availableOptions: SchematicAvailableOptions) => {
                this.registerOptions({ availableOptions: availableOptions });
            });
    },
    ...
    run: function(commandOptions: any, rawArgs: string[]) {
        ...
        if (!packageName) {
            return Promise.reject(
                new SilentError(
                    `The "ng ${
                        this.name
                    }" command requires a name argument to be specified eg. ` +
      ...
      `
        ...
        commandOptions.skipGit =
            commandOptions.skipGit === undefined
                ? false
                : commandOptions.skipGit;
