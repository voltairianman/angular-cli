...
describe("Config", () => {
    let schema = JSON.parse(
        fs.readFileSync(path.join(__dirname, "spec-schema.json"), "utf-8")
    );
    ...
    describe("Get", () => {
        ...
        it("will never throw", () => {
            ...
            expect(config.get("arrayKey2[0].stringKey.a.b.c.d")).toEqual(
                undefined
            );
        });
    });
    ...
    it("saves", () => {
        ...
        expect(JSON.stringify(JSON.parse(cliConfig.serialize()))).toEqual(
